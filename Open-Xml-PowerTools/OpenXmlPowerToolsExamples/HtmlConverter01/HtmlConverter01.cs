...
class HtmlConverterHelper
{
    ...
    {
        //var n = DateTime.Now;
        //var tempDi = new DirectoryInfo(string.Format("E:\\_docx\\books\\output\\ExampleOutput-{0:00}-{1:00}-{2:00}-{3:00}{4:00}{5:00}", n.Year - 2000, n.Month, n.Day, n.Hour, n.Minute, n.Second));
        //tempDi.Create();
        ...
        //foreach (var file in Directory.GetFiles("D:\\1\\letters2\\", "*.docx"))

        var inputDirectoryName = "c:\\work\\other\\_docx\\books\\1";
        ...
        /*foreach(var book_dir in Directory.GetDirectories("c:\\work\\other\\_docx\\books\\uh"))
        {
    ...
    public static void ConvertToHtml(string file, string outputDirectory)
    {
        ...
        using (MemoryStream memoryStream = new MemoryStream())
        {
            ...
            using (WordprocessingDocument wDoc = WordprocessingDocument.Open(memoryStream, true))
            {
                ...
                {
                    AdditionalCss = "article.article_body > div { margin: 40px; }",
                    PageTitle = pageTitle,
                    ...
                    ImageHandler = imageInfo =>
                    {
                        ...
                        var imageSource = "data:" + mimeType + ";base64," + Convert.ToBase64String((Byte[])(new ImageConverter().ConvertTo(imageInfo.Bitmap, typeof(Byte[]))));
